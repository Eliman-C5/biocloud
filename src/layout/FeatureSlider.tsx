...
export const FeatureSlider = () => {
  return (
    <section className="section pt-100 pt-50 pb-100" style={{background: '#fff'}}>
              ...
              >
                          ...
                          <div> 
                            ...
                            <div className="row">
                                <div className="col-lg-6 d-block d-lg-none">
                                  <img className="d-block w-100" src='media/mobileApp1.png' alt="iori" />
                                </div>
                      ...
                      <SwiperSlide className="swiper-slide">
                          <div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 d-block d-lg-none">
                                  <img className="d-block w-100" src='media/mobileApp2.png' alt="iori" />
                                </div>
                                <div className={`col-lg-6 d-flex terminales-text`}>
                                        <FeatureSliderCard>
                      ...
                      <SwiperSlide className="swiper-slide">
                          <div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 d-block d-lg-none">
                                  <img className="d-block w-100" src='media/mobileApp3.png' alt="iori" />
                                </div>
                                <div className={`col-lg-6 d-flex terminales-text`}>
                                        <FeatureSliderCard>
                                          <div className="">
                                            ...
                                            <ul className='d-flex flex-column' style={{gap: '10px'}}>
                                              <li>
                                              {
                                                items.map((item) => <div className="font-md" key={item.id}>
                                                  <svg className="w-6 h-6" style={{color: '#28A7E6', height: '16px'}} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
