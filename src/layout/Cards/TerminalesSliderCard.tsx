...
export const TerminalesSliderCard = ({children}: childrenProp) => {
  return (
    <div className='d-flex flex-column' style={{gap: '20px', justifyContent: 'space-around', height: '100%'}}>
      <div className="">
        <h3 className='color-grey-900'>Terminales Multi Biométricas</h3>
      </div>
      {children}
      <div className="box-button-slider-bottom">
          <div className="swiper-button-prev swiper-button-prev-group-4 swiper-button-prev-style-4">
          ...
          <div className="swiper-button-next swiper-button-next-group-4 swiper-button-next-style-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="11" height="18" viewBox="0 0 11 18" fill="none">
