...
export const TerminalesSlider = () => {
  return (
    <section className="section pt-100 pt-50 margin-mobile " style={{background: '#fff'}} id='biometricos'>
                                ...
                                <div className={`col-lg-6 d-flex`}>
                                        <TerminalesSliderCard>
                                            ...
                                            <div className="d-flex flex-column" style={{gap: '10px'}}>
                                              <h6 className='color-grey-900 mb-10'>Nueva tecnología de reconocimiento facial en movimiento, sin contacto y completamente higiénico</h6>
